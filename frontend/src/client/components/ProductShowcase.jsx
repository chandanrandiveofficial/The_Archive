    ...
    <section id="products-showcase" className="bg-white py-12 lg:py-16">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-[1400px]">
        ...
        {data.bestsellers.length > 0 && (
          <div className="mb-16">
            <h2 className="text-3xl font-bold text-black mb-6">Main Showcase</h2>
        ...
        {data.currentMonth.products.length > 0 && (
          <div id={`year-section-${data.currentMonth.year}`} className="mb-16">
        ...
        {data.previousMonth.products.length > 0 && (
          <div id={`year-section-${data.previousMonth.year}`} className="mb-16">
            <h2 className="text-base font-bold text-black mb-4">
        ...
        {data.yearlyCollections.map((yearData) => (
          <div key={yearData.year} id={`year-section-${yearData.year}`} className="mb-16">
