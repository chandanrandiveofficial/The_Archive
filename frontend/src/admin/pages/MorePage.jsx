    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 sm:gap-0 mb-8">
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">Content Overview</h1>
          ...
          <div className="flex items-center gap-2 sm:gap-3 w-full sm:w-auto">
            <button
              ...
              className="p-2 sm:p-2.5 text-gray-600 hover:bg-gray-100 rounded-lg transition-colors flex-shrink-0"
              title="Refresh"
            >
            ...
            <Link
              ...
              className="flex items-center gap-2 px-4 py-2.5 bg-black text-white font-medium rounded-lg hover:bg-gray-800 transition-colors flex-1 sm:flex-none justify-center sm:justify-start"
            >
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex items-center gap-3 flex-1 min-w-0">
                      ...
                      <button
                        ...
                        className={`px-2.5 py-0.5 text-xs font-semibold rounded cursor-pointer hover:opacity-80 transition-opacity flex-shrink-0 ${block.status === 'PUBLISHED'
                  ...
                  <div className="flex items-center gap-2 pt-2">
                    <Link
                      to={`/more/${block.slug}`}
                      target="_blank"
                      className="flex-1 text-center px-4 py-2 text-gray-600 font-medium hover:bg-gray-100 rounded-lg transition-colors text-sm"
                    >
                      View
                    </Link>
                    <button
                      onClick={() => handleEdit(block._id)}
                      className="flex-1 px-4 py-2 text-gray-700 font-medium hover:bg-gray-100 rounded-lg transition-colors text-sm"
                    >
                      Edit
                    </button>
                    <button
        ...
        {contentBlocks.length === 0 && !loading && (
          <div className="bg-white rounded-lg border border-gray-200 p-8 sm:p-12 text-center">
            ...
            <Link
              to="/admin/addmorepage"
              className="inline-flex items-center gap-2 px-4 py-2.5 bg-black text-white font-medium rounded-lg hover:bg-gray-800 transition-colors block mx-auto sm:inline-block w-full sm:w-auto max-w-xs"
            >
              <FiPlus className="w-4 h-4" />
        ...
        {contentBlocks.length > 0 && (
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 sm:gap-0 bg-white p-4 sm:p-6 rounded-lg border border-gray-200">
