          ...
          <div className="flex items-center justify-between pt-6 border-t border-gray-200">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                onClick={handleSave}
                disabled={saving}
                className="flex items-center gap-2 px-6 py-2.5 bg-black text-white font-medium hover:bg-gray-800 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black"
              >
